    ...
    fetchAdminStatus()
      ...
      .catch(() => {
        setStatus({
          ...
          loaded_models: ['qwen2.5:latest', 'nomic-embed-text:latest']
        });
      });
  }, []);
        ...
        <div className="bg-[#05070a] border border-slate-800 p-5 rounded-xl space-y-3">
          ...
          <div className="space-y-2 text-xs">
            ...
            <div className="p-2 rounded bg-slate-900/60 border border-slate-800 space-y-1">
              ...
              <span className="text-[#e0883f] font-mono block">qwen2.5:latest (Chat & Safety)</span>
              <span className="text-[#3fd8c4] font-mono block">nomic-embed-text:latest (Embeddings)</span>
            </div>
          </div>
        </div>
      </div>
